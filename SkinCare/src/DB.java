...
public class DB {
    ...
    private void initializeDB() {
        ...
        Sunscreen sunscreen2 =  new Sunscreen("50","UV Aqua Rich Watery Essence SPF", "Biore", 8.99);
        Sunscreen sunscreen3 =  new Sunscreen("36","Daily UV Defense Sunscreen", "innisfree", 16.00);
        Sunscreen sunscreen4 =  new Sunscreen("50","All Round Safe Block Aqua Sun Gel SPF", "Missha", 10.55);
    ...
    public void printWater(){
        ...
        System.out.println("\n[" + (waterCleanser.size() + 1) +  "] Main Menu");
