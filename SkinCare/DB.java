...
public class DB {
     ...
     */
    public void genThree(CareList cl) {
        Random r = new Random();
     ...
     */
    public void genFour(CareList cl) {
        Random r = new Random();
        int rand1 = r.nextInt(waterCleanser.size());
        int rand2 = r.nextInt(toner.size());
        int rand3 = r.nextInt(lotion.size());
     ...
     */
    public void genFive(CareList cl) {
        Random r = new Random();
        int rand1 = r.nextInt(waterCleanser.size());
        int rand2 = r.nextInt(toner.size());
        int rand3 = r.nextInt(lotion.size());
     ...
     */
    public void genSix(CareList cl) {
        Random r = new Random();
        int rand1 = r.nextInt(waterCleanser.size());
        int rand2 = r.nextInt(toner.size());
        int rand3 = r.nextInt(lotion.size());
     ...
     */
    public void genSeven(CareList cl) {
        Random r = new Random();
        int rand1 = r.nextInt(waterCleanser.size());
        int rand2 = r.nextInt(toner.size());
        int rand3 = r.nextInt(lotion.size());
     ...
     */
    public void genEight(CareList cl) {
        Random r = new Random();
        int rand1 = r.nextInt(waterCleanser.size());
        int rand2 = r.nextInt(toner.size());
        int rand3 = r.nextInt(lotion.size());
